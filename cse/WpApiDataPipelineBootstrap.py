...
class WpApiDataPipelineBootstrap(Handler):
    ...
    def crawl(self, url):
        ...
        print("Processed comments: " + str(self.__countHandler.getCount()))
...
if __name__ == "__main__":
    ...
    bs.setupPipeline()
    bs.crawl(url='https://www.washingtonpost.com/politics/courts_law/supreme-court-to-consider-major-digital-privacy-case-on-microsoft-email-storage/2017/10/16/b1e74936-b278-11e7-be94-fabb0f1e9ffb_story.html')
    ...
    bs.crawl(url='https://www.washingtonpost.com/news/wonk/wp/2017/11/02/winners-and-losers-in-the-gop-tax-plan/?hpid=hp_hp-top-table-main_tax-winnerslosers-230pm%3Ahomepage%2Fstory&utm_term=.d2381570c5bc')
    writer.close()
